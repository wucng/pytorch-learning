...
# make fake data
n_data = np.ones((100, 2),dtype=np.float32)

x0 = preprocessing.normalize(2*n_data, axis=1)      # class0 x data (tensor), shape=(100, 2)
y0 = np.zeros(100,np.int32)               # class0 y data (tensor), shape=(100, 1)
x1 = preprocessing.normalize(-2*n_data, axis=1)     # class1 x data (tensor), shape=(100, 2)
